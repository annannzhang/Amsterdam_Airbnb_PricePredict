...
## Room Composition / Characteristics
...
## New Feature 3: Proximity to Tourist Spots
...
Plot airbnb by smaller neighborhood
...
neighbor2 %>% ggplot() + 
      ...
      scale_fill_gradient(low = '#f3c226', high = palette5[5],
                          name = "Airbnb Number") +
      labs(title = "Airbnb Number for Each ZIP") +
      mapTheme
...
ggplot()+
  ...
  labs(title = "Airbnb Number for Each neighborhood")+
  mapTheme
...
Local amenities affect on housing price
...
do.call(grid.arrange,c(plotList, ncol = 3, top = "Amenities vs. Price"))
```
